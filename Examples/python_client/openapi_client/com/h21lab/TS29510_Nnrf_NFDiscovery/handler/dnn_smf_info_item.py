...
class DnnSmfInfoItem(object):
    ...
    def __init__(self, dnn=None, local_vars_configuration=None):  # noqa: E501
        """DnnSmfInfoItem - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def dnn(self):
        """Gets the dnn of this DnnSmfInfoItem.  # noqa: E501


        :return: The dnn of this DnnSmfInfoItem.  # noqa: E501
        :rtype: str
        """
        return self._dnn
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DnnSmfInfoItem):
            return False
