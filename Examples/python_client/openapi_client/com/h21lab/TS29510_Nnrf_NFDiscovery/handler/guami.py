...
class Guami(object):
    ...
    def __init__(self, plmn_id=None, amf_id=None, local_vars_configuration=None):  # noqa: E501
        """Guami - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def plmn_id(self):
        """Gets the plmn_id of this Guami.  # noqa: E501


        :return: The plmn_id of this Guami.  # noqa: E501
        :rtype: PlmnId
        """
    ...
    @property
    def amf_id(self):
        """Gets the amf_id of this Guami.  # noqa: E501


        :return: The amf_id of this Guami.  # noqa: E501
        :rtype: str
        """
        return self._amf_id
    ...
    def amf_id(self, amf_id):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and amf_id is None:  # noqa: E501
            raise ValueError("Invalid value for `amf_id`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                amf_id is not None and not re.search(r'^[A-Fa-f0-9]{6}$', amf_id)):  # noqa: E501
            raise ValueError(r"Invalid value for `amf_id`, must be a follow pattern or equal to `/^[A-Fa-f0-9]{6}$/`")  # noqa: E501
