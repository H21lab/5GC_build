...
class Tai(object):
    ...
    def __init__(self, plmn_id=None, tac=None, nid=None, local_vars_configuration=None):  # noqa: E501
        """Tai - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def plmn_id(self):
        """Gets the plmn_id of this Tai.  # noqa: E501


        :return: The plmn_id of this Tai.  # noqa: E501
        :rtype: PlmnId
        """
    ...
    @property
    def tac(self):
        """Gets the tac of this Tai.  # noqa: E501


        :return: The tac of this Tai.  # noqa: E501
        :rtype: str
        """
        return self._tac
    ...
    def tac(self, tac):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and tac is None:  # noqa: E501
            raise ValueError("Invalid value for `tac`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                tac is not None and not re.search(r'(^[A-Fa-f0-9]{4}$)|(^[A-Fa-f0-9]{6}$)', tac)):  # noqa: E501
            raise ValueError(r"Invalid value for `tac`, must be a follow pattern or equal to `/(^[A-Fa-f0-9]{4}$)|(^[A-Fa-f0-9]{6}$)/`")  # noqa: E501

        self._tac = tac

    @property
    def nid(self):
        """Gets the nid of this Tai.  # noqa: E501


        :return: The nid of this Tai.  # noqa: E501
        :rtype: str
        """
        return self._nid
