...
class CompleteStoredSearchDocumentApi(object):
    ...
    def retrieve_complete_search(self, search_id, **kwargs):  # noqa: E501
        """retrieve_complete_search  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.retrieve_complete_search(search_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.retrieve_complete_search_with_http_info(search_id, **kwargs)  # noqa: E501

    def retrieve_complete_search_with_http_info(self, search_id, **kwargs):  # noqa: E501
        """retrieve_complete_search  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.retrieve_complete_search_with_http_info(search_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method retrieve_complete_search" % key
                )
        ...
        if self.api_client.client_side_validation and ('search_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `search_id` when calling `retrieve_complete_search`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/searches/{searchId}/complete', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
