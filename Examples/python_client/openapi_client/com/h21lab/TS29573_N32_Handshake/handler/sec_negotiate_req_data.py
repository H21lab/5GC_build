...
class SecNegotiateReqData(object):
    ...
    def __init__(self, sender=None, supported_sec_capability_list=None, local_vars_configuration=None):  # noqa: E501
        """SecNegotiateReqData - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._sender = None
        self._supported_sec_capability_list = None
        self.discriminator = None

        self.sender = sender
        self.supported_sec_capability_list = supported_sec_capability_list

    @property
    def sender(self):
        """Gets the sender of this SecNegotiateReqData.  # noqa: E501

        Fully Qualified Domain Name  # noqa: E501

        :return: The sender of this SecNegotiateReqData.  # noqa: E501
        :rtype: str
        """
        return self._sender
    ...
    def supported_sec_capability_list(self):
        """Gets the supported_sec_capability_list of this SecNegotiateReqData.  # noqa: E501


        :return: The supported_sec_capability_list of this SecNegotiateReqData.  # noqa: E501
    ...
    def supported_sec_capability_list(self, supported_sec_capability_list):
        ...
        :type: list[SecurityCapability]
        """
        if self.local_vars_configuration.client_side_validation and supported_sec_capability_list is None:  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SecNegotiateReqData):
            return False
