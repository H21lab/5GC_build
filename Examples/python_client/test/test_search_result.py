...
from openapi_client.com.h21lab.TS29510_Nnrf_NFDiscovery.handler.search_result import SearchResult  # noqa: E501
    ...
    def make_instance(self, include_optional):
        ...
        if include_optional :
            return SearchResult(
                ...
                preferred_search = openapi_client.models.preferred_search.PreferredSearch(
                    preferred_tai_match_ind = True, ), 
                nrf_supported_features = 'a'
            )
        else :
            return SearchResult(
                nf_instances = [
