...
class TestStoredSearchDocumentController(BaseTestCase):
    """StoredSearchDocumentController integration test stubs"""
    ...
    def test_retrieve_stored_search(self):
        ...
        response = self.client.open(
            '/nnrf-disc/v1/searches/{search_id}'.format(search_id='search_id_example'),
            method='GET',
            headers=headers)
